    ...
    (function() {
        ...
        (function(root, factory) {
            ...
            var Preferences = {
                ...
                initialize: function preferencesInitialize() {
                    return (this.initializedPromise = defaultPreferences
                        .then(
                            function(defaults) {
        ...
        (function(root, factory) {
            ...
            PDFJS.ignoreCurrentPositionOnZoom =
                PDFJS.ignoreCurrentPositionOnZoom === undefined ? false : PDFJS.ignoreCurrentPositionOnZoom;
            /**
       ...
       */
            ...
            var PDFDocumentProperties = (function PDFDocumentPropertiesClosure() {
                ...
                PDFDocumentProperties.prototype = {
                    ...
                    open: function PDFDocumentProperties_open() {
                        Promise.all([OverlayManager.open(this.overlayName), this.dataAvailablePromise]).then(
                            function() {
                                this._getProperties();
                            }.bind(this)
                        );
            ...
            PDFHistory.prototype = {
                ...
                push: function pdfHistoryPush(params, isInitialBookmark) {
                    ...
                    if (params.dest && !params.hash) {
                        params.hash =
                            this.current.hash && this.current.dest && this.current.dest === params.dest
                                ? this.current.hash
                ...
                PDFLinkService.prototype = {
                        ...
                        var goToDestination = function(destRef) {
                            ...
                            if (pageNumber) {
                                if (pageNumber > self.pagesCount) {
                                    console.error(
                                        "PDFLinkService_navigateTo: " + "Trying to navigate to a non-existent page."
                                    );
                                    return;
                                }
                    ...
                    setHash: function PDFLinkService_setHash(hash) {
                        ...
                        if (hash.indexOf("=") >= 0) {
                            ...
                            if ("zoom" in params) {
                                ...
                                if (zoomArg.indexOf("Fit") === -1) {
                                    ...
                                    if (zoomArg === "Fit" || zoomArg === "FitB") {
                                        ...
                                        console.error(
                                            "PDFLinkService_setHash: '" + zoomArg + "' is not a valid zoom value."
                                        );
                                    }
                                }
                            }
                            ...
                            console.error(
                                "PDFLinkService_setHash: '" + unescape(hash) + "' is not a valid destination."
                            );
                        }
                    },
                    /**
            ...
            var TextLayerBuilder = (function TextLayerBuilderClosure() {
                ...
                TextLayerBuilder.prototype = {
                    ...
                    renderMatches: function TextLayerBuilder_renderMatches(matches) {
                        ...
                        var highlightAll =
                            this.findController === null ? false : this.findController.state.highlightAll;
                        var infinity = {
                            divIdx: -1,
                            offset: undefined
                        };
            ...
            var PDFViewer = (function pdfViewer() {
                ...
                PDFViewer.prototype /** @lends PDFViewer.prototype */ = {
                    ...
                    scrollPageIntoView: function PDFViewer_scrollPageIntoView(params) {
                        ...
                        var pageWidth =
                            (changeOrientation ? pageView.height : pageView.width) / pageView.scale / CSS_UNITS;
                        var pageHeight =
                            (changeOrientation ? pageView.width : pageView.height) / pageView.scale / CSS_UNITS;
                        var scale = 0;
                        switch (dest[1].name) {
                            case "XYZ":
                                x = dest[2];
        ...
        (function(root, factory) {
                        ...
                        store.initializedPromise.then(
                            function resolved() {
                                ...
                                if (self.preferenceShowPreviousViewOnLoad && store.get("exists", false)) {
                                    ...
                                    var zoom =
                                        self.preferenceDefaultZoomValue || store.get("zoom", DEFAULT_SCALE_VALUE);
                ...
                _updateUIToolbar: function(params) {
                    function selectScaleOption(value, scale) {
                        ...
                        if (!predefinedValueFound) {
                            ...
                            toolbarConfig.customScaleOption.textContent = mozL10n.get(
                                "page_scale_percent",
                                { scale: customScale },
                                "{{scale}}%"
                            );
                ...
                Promise.all(waitForBeforeOpening)
                    ...
                    .catch(function(reason) {
                        PDFViewerApplication.error(
                            mozL10n.get("loading_error", null, "An error occurred while opening."),
                            reason
                        );
                    });
            }
            ...
            webViewerOpenFileViaURL = function webViewerOpenFileViaURL(file) {
                if (file && file.lastIndexOf("file:", 0) === 0) {
                    ...
                    try {
                        ...
                        PDFViewerApplication.error(
                            mozL10n.get("loading_error", null, "An error occurred while loading the PDF."),
                            e
                        );
                    }
                    return;
            ...
            function webViewerPageRendered(e) {
                ...
                if (pageView.error) {
                    PDFViewerApplication.error(
                        mozL10n.get("rendering_error", null, "An error occurred while rendering the page."),
                        pageView.error
                    );
                }
            }
            ...
            PDFPrintService.prototype = {
                ...
                renderPages: function() {
                    ...
                    var renderNextPage = function(resolve, reject) {
                        ...
                        renderPage(this.pdfDocument, index + 1, this.pagesOverview[index], this.wrappers[index]).then(
                            function() {
